...
from data.dataset import (
    ...
    prepare_dataset_unknown_fact_binary_span_all,
)
...
args = parse_args()
if args.use_all:
    testset = prepare_dataset_unknown_fact_binary_span_all(
        args.data_file, annotator_id=args.annotator_id
    )
else:
    _, testset = prepare_dataset_unknown_fact_binary_span(
        args.data_file, annotator_id=args.annotator_id
    )
_summarise_unknown_fact_split("eval", testset)
