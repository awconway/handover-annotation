...
from sbar_span_task.langextract_experiment import run_langextract_sbar_experiment

DATA_FILE = "./annotated_data/db_20260129_tokenised.jsonl"
OUTPUT_FILE = "./evals/eval_sbar_langextract.jsonl"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Use the same deterministic split as data.dataset.prepare_dataset_sbar_span "
...
print(
    "LangExtract SBAR experiment complete.",
