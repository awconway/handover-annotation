...
from unknown_fact_binary_span_task.langextract_experiment import (
    run_langextract_unknown_fact_experiment,
)

DATA_FILE = "./annotated_data/db_20260129_tokenised.jsonl"
OUTPUT_FILE = "./evals/eval_unknown_fact_langextract.jsonl"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Use the same deterministic split as "
            "data.dataset.prepare_dataset_unknown_fact_binary_span "
...
summary = run_langextract_unknown_fact_experiment(
...
print(
    "LangExtract unknown fact experiment complete.",
