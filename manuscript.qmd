...
Figure @fig-results-overview summarizes matched within-model comparisons across tasks for the three models evaluated in the main study. Where more than one saved run existed for the same task, model, and approach, the highest observed micro-F1 for that combination is shown.
