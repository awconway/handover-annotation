...
Within-model comparisons showed consistent point-estimate gains with DSPy/GEPA over matched baselines wherever both were available. For GPT-5.2, micro-F1 increased from `{python} fmt_metric_ci_text(checklist_gpt52_baseline, "micro_f1")` to `{python} fmt_metric_ci_text(checklist_gpt52_dspy, "micro_f1")` for checklist prediction, from `{python} fmt_metric_ci_text(sbar_gpt52_baseline, "micro_f1")` to `{python} fmt_metric_ci_text(sbar_gpt52_dspy, "micro_f1")` for SBAR span extraction, from `{python} fmt_metric_ci_text(uncertain_gpt52_baseline, "micro_f1")` to `{python} fmt_metric_ci_text(uncertain_gpt52_dspy, "micro_f1")` for uncertainty span extraction, and from `{python} fmt_metric_ci_text(unknown_gpt52_baseline, "micro_f1")` to `{python} fmt_metric_ci_text(unknown_gpt52_dspy, "micro_f1")` for unknown-fact extraction. Across span tasks, LangExtract generally performed below the corresponding best DSPy/GEPA configuration.
